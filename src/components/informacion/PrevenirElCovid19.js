    ...
    <div className="container marketing">
      <div className="row">
        <div className="col-lg5">
          ...
          <p> </p>
          <h2>
            1. LO MÁS IMPORTANTE LÁVATE LAS MANOS CON FRECUENCIA CON AGUA Y
            JABÓN
          </h2>
        </div>
        ...
        <div className="col-lg-4">
          ...
          <p> </p>
          <h2>
            2. CÚBRETE LA BOCA CON EL ANTEBRAZO O CON UN PAÑUELO AL TOSER O
            ESTORNUDAR
          </h2>
        </div>
        ...
        <div className="col-lg-4">
          ...
          <p> </p>
          <h2>
            4. SI PRESENTAS SÍNTOMAS RESPIRATORIOS Y HAS VIAJADO A UNA ZONA DE
            RIESGO, PERMANECE EN CASA Y LLAMA AL 911
          </h2>
        </div>
      </div>
      <hr></hr>
      <section className="DatosRegionesPeru jumbotron text-center">
        <div className=" text-center">
          <h2 className="display-4" sx={{ color: "text" }}>
            <b>¿Cómo prevenir el Coronavirus (COVID-19)?</b>{" "}
          </h2>
          <div className="contenedor">
            <iframe
              title="Video the Covid-19"
              width="580"
              height="350"
              src="https://www.youtube.com/embed/uvOWHLab7Gg"
              frameBorder="0"
