...
import Foto4 from '../../assets/img/kike.jpeg'
    ...
    return (
        <div className="container marketing">
            <div className="row">
                ...
                */}
                <div className="col-lg-4">
                <img alt="Jose Cueva Celis" className="bd-placeholder-img rounded-circle" width="140" height="140" src={Foto4} preserveAspectRatio="xMidYMid slice" focusable="false" aria-label="Placeholder: 140x140"></img>
                    <h2>Luis Rodriguez Merino</h2>
                    <p>Programador Front-End, Back-End y Fundador.</p>
                    <p>Hice este proyecto para probar mis habilidades de react aprendidas hasta el momento y tambien ayudar a la gente a mantenerse informada en los peores momentos de la pandemia.</p>
                    <p><a className="btn btn-secondary" href="https://www.linkedin.com/in/luis-rodriguez-merino-50123a24b/" target="_blank" rel="noopener noreferrer" role="button">Ver más detalles »</a></p>
                </div>
